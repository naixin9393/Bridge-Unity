...
namespace BridgeEdu.Game.Bidding {
    public class BiddingPhase : IBidding {
        ...
        public BiddingPhase(List<IPlayer> players, IPlayer dealer) {
            _players = players;
            _dealer = dealer;
        ...
        public BiddingPhase(List<IPlayer> players, IPlayer dealer, IPlayer human, IBiddingEngine biddingEngine) {
            _players = players;
            _dealer = dealer;
            _human = human;
            CurrentPlayer = dealer;
