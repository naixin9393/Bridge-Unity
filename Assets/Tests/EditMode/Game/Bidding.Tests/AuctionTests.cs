...
namespace BridgeEdu.Game.Bidding.Tests {
    public class BiddingTests {
        ...
        public void Dealer_ShouldBe_ExpectedPlayer(int playerIndex) {
            ...
            var auction = new BiddingPhase(players, players[playerIndex]);
        ...
        [TestCase(0, 0, TestName = "ShouldUpdateBiddingState_Bid-Bid-Bid-Bid")]
        [TestCase(2, 1, TestName = "ShouldUpdateBiddingState_Pass-Bid-Bid-Bid")]
        [TestCase(1, 2, TestName = "ShouldUpdateBiddingState_Bid-Pass-Bid-Double")]
        [TestCase(3, 3, TestName = "ShouldUpdateBiddingState_Bid-Double-Redouble-Pass")]
        [TestCase(3, 4, TestName = "ShouldUpdateBiddingState_Bid-Pass-Pass-Pass")]
        public void Bidding_MakeCall_ShouldUpdateBiddingState_WhenCallerMakesValidCall(int playerIndex, int callsIndex) {
            var players = CreateTestPlayers();
        ...
        public void Bidding_MakeCall_ShouldThrowException_WhenDealerMakesInvalidCall(int playerIndex, CallType callType) {
            var players = CreateTestPlayers();
            var auction = new BiddingPhase(players, players[playerIndex]);
        ...
        [Test]
        public void Bidding_MakeCall_ShouldThrowException_WhenDealerMakesCallFromAnotherPlayer() {
            var players = CreateTestPlayers();
            var auction = new BiddingPhase(players, players[0]);
        ...
        public void Bidding_MakeCall_ShouldThrowException_WhenCallerMakesLowerOrEqualBidThanLastCall(int level1, Strain strain1, int level2, Strain strain2) {
            var players = CreateTestPlayers();
            var auction = new BiddingPhase(players, players[0]);
        ...
        [Test]
        public void Bidding_MakeCall_ShouldThrowException_WhenNotPlayersTurn() {
            var players = CreateTestPlayers();
            var auction = new BiddingPhase(players, players[0]);
        ...
        [Test]
        public void Bidding_MakeCall_ShouldThrowException_WhenDoubleAfterNonBidCall() {
            var players = CreateTestPlayers();
            var auction = new BiddingPhase(players, players[0]);
            auction.MakeCall(new Pass(players[0]));
        ...
        [Test]
        public void Bidding_MakeCall_ShouldThrowException_WhenRedoubleAfterNonDoubleCall() {
            var players = CreateTestPlayers();
            var auction = new BiddingPhase(players, players[0]);
            auction.MakeCall(new Pass(players[0]));
        ...
        [Test]
        public void Bidding_ShouldEnd_AfterFourInitialConsecutivePasses() {
            var players = CreateTestPlayers();
            var auction = new BiddingPhase(players, players[0]);
            auction.MakeCall(new Pass(players[0]));
        ...
        [Test]
        public void Bidding_ShouldEnd_AfterThreeConsecutivePasses_WithBid() {
            var players = CreateTestPlayers();
            var auction = new BiddingPhase(players, players[0]);
        ...
        [Test]
        public void Bidding_ShouldEnd_AfterThreeConsecutivePasses_WithBid2() {
            var players = CreateTestPlayers();
            var auction = new BiddingPhase(players, players[0]);
            auction.MakeCall(new BidCall(new Bid(1, Strain.NoTrump), players[0]));
            Assert.IsFalse(auction.IsOver);
